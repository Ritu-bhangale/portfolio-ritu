          ...
          <div className={styles.leftCol}>
            <div className={styles.photoBlock}>
              ...
              <Text as="span" size="m">
                ...
                product ecosystems, uncovering complex challenges, and crafting/ experimenting
                thoughtful solutions that truly resonate with users.
                      </Text>
            </div>
              ...
              <div className={styles.eduBlock}>
                ...
                <div className={styles.eduDetails}>
                  <div className={styles.eduNameBlock}>
                    <div className={styles.eduDegree}>Bachelors of technology</div>
              ...
              {experiences.map((exp, i) => (
                <div key={i} className={styles.timelineItem}>
                  <div className={styles.timelineTrack}>
                    {i === 0 && <div className={styles.timelineSpacerTop} />}
                  ...
                  <div className={styles.timelineContent}>
                    <div className={styles.expPeriod}><Text as="span" size="m">
                        {exp.period}
                      </Text></div>
                    <div className={styles.expDetails}>
                      <div className={styles.expNameBlock}>
                        ...
                        <div className={styles.expCompany}>
                          <span className={styles.expCompanyName}>{exp.companyName}</span>
